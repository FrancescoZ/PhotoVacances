 ...
 */
//Fragment qui gere la list des album
public class ListNameAdapter extends ArrayAdapter<Album> implements Filterable {

    //list filtre
    private List<Album> albumList;
    private Context context;
    //il nous permet de faire le filtrage sur la list
    private Filter filter;
    //list du debut
    private List<Album> origAlbumList;

    public ListNameAdapter(Context context, int resource, List<Album> albums) {
    ...
    //Filter qui cherche dans la list des album
